...
public class PlayerJsonData {
    ...
    public PlayerJsonData(UUID playerUuid, String playerNick, EconomyData economyData, List<Integer> memberOfCampsWithID){
    ...
    public PlayerData convertToPlayerData(Player player){
        return new PlayerData(UUID.fromString(playerUuid), playerNick,
                EconomySerializer.deserialize(player, economyData), IdCampSerializer.deserialize(memberOfCampsWithID));
    }
}
